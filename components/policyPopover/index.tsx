export default function PolicyPopover() {
  return (
    ...
    >
      ...
      <h3 style={{ marginTop: "30px", marginBottom: "15px" }}>Definitions</h3>
      ...
      <ul style={{ paddingLeft: "20px", marginTop: "15px" }}>
        ...
        <li style={{ marginBottom: "10px" }}>
          <p>
            ...
            this Agreement) refers to ZokunTechnologies, 1713 N 114th Ave.
          </p>
        </li>
        <li style={{ marginBottom: "10px" }}>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Zokun Advertisement, accessible
            from{" "}
            <a
              href="https://zokunads.com"
      ...
      <h3 style={{ marginBottom: "15px" }}>Types of Data Collected</h3>

      <h4 style={{ marginBottom: "10px" }}>Personal Data</h4>
      ...
      <h4 style={{ marginTop: "30px", marginBottom: "10px" }}>Usage Data</h4>
      ...
      <ul style={{ paddingLeft: "20px", marginTop: "15px" }}>
        <li>By email: zokuntechnologies@gmail.com</li>
      </ul>
    </div>
  );
}
